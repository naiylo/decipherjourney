...
public class StoryModeService {
    ...
    public StoryMode initializeStoryParts() {
        ...
        storyTwo.setDialogs(List.of(List.of(
            ...
            "Kip: Jetzt wo du weißt wie sie funktioniert kannst du es ja selber kurz ausprobieren. Hier schau auf diese Tafel und verschlüssele das Wort Kolosseum, indem du eine Verschiebung von 3 nutzt.",
        ...
        storyThree.setDialogs(List.of(List.of(
            ...
            "Kip: Sprich vielleicht mit dieser Person da. Eventuell kann sie dir etwas über die Chiffre erzählen?",
            "...",
            "Fremder: Guten Tag! Du siehst aus, als wärst du auf einer spannenden Reise. Kann ich dir etwas anbieten? Vielleicht eine Zeitung, da sind lustige Rätsel drin?",
